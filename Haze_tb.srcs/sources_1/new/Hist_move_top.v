...
endwire [7:0] img_r_temp;wire [7:0] img_b_temp;assign img_r_temp = r_img_l_oa_max >= r_img_r_oa_max ? img_r >= r_oa_max_pashe ? img_r - r_oa_max_pashe : 0 : img_r + r_oa_max_pashe;assign img_b_temp = b_img_l_oa_max >= b_img_r_oa_max ? img_b >= b_oa_max_pashe ? img_b - b_oa_max_pashe : 0 : img_b + b_oa_max_pashe;
assign o_img_hs = img_hs;
assign o_img_vs = img_vs;
assign o_img_r  = img_r_temp >= 255 ? 255 : img_r_temp;
assign o_img_g  = img_g;
assign o_img_b  = img_b_temp >= 255 ? 255 : img_b_temp;
endmodule
